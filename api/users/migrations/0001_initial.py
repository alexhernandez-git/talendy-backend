    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_for_withdrawn_date', models.DateTimeField(default=datetime.datetime(2021, 3, 28, 17, 54, 11, 892138, tzinfo=utc), help_text='Date time on pending clearance ends.', verbose_name='pending clearance expiration at')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created', '-modified'],
