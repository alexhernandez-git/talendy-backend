    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_for_withdrawn_date', models.DateTimeField(auto_now_add=True, help_text='Date time on pending clearance ends.', verbose_name='pending clearance expiration at')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created', '-modified'],
