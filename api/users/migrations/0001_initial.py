...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notifications', '0002_notificationuser_portal'),
        ('posts', '0001_initial'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='portals.Portal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portals.Portal')),
                ...
                ('reviewd_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviewd_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='Date time on which the object was created.', verbose_name='created at')),
                ('modified', models.DateTimeField(auto_now=True, help_text='Date time on which the object was last modified.', verbose_name='modified at')),
                ('type', models.CharField(choices=[('RE', 'Refunded'), ('ED', 'Earned by donation'), ('EA', 'Earned'), ('SP', 'Spent')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='Date time on which the object was created.', verbose_name='created at')),
                ('modified', models.DateTimeField(auto_now=True, help_text='Date time on which the object was last modified.', verbose_name='modified at')),
                ('followed_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_followed_member', to='portals.PortalMember')),
                ('from_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_follow_member', to='portals.PortalMember')),
                ('portal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portals.Portal')),
            ],
            options={
                'ordering': ['-created', '-modified'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addressee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addressee', to='portals.PortalMember')),
                ('portal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portals.Portal')),
                ('requester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requester', to='portals.PortalMember')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
