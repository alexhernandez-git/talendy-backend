...
Genereviewd by 'django-admin startproject' using Django 3.0.3.
...
if DEBUG:
    ...
    ALLOWED_HOSTS.append("contributerooms")
    ALLOWED_HOSTS.append("django")
    CORS_ALLOWED_ORIGINS.append("http://localhost:3000")
    CORS_ALLOWED_ORIGINS.append("http://chats:5400")
    CORS_ALLOWED_ORIGINS.append("http://contributerooms:5500")
...
OPEN_EXCHANGE_RATES_URL = 'https://openexchangereviews.org/api/historical/2017-01-01.json?symbols=USD,EUR,NOK,SEK,CZK'
